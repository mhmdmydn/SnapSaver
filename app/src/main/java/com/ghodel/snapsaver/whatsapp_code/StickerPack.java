...
public class StickerPack implements Parcelable {
    ...
    public static final Creator<StickerPack> CREATOR = new Creator<StickerPack>() {
        @Override
        public com.ghodel.snapsaver.whatsapp_code.StickerPack createFromParcel(Parcel in) {
            return new com.ghodel.snapsaver.whatsapp_code.StickerPack(in);
        }

        @Override
        public com.ghodel.snapsaver.whatsapp_code.StickerPack[] newArray(int size) {
            return new com.ghodel.snapsaver.whatsapp_code.StickerPack[size];
        }
    };
